              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 mt-1 leading-relaxed">
                      Ensure this app's domain is in your Firebase authorized domains list.
                    </p>
                    <div className="mt-2 flex items-center gap-2">
                      <code className="px-2.5 py-1 rounded bg-slate-100 border border-slate-200 text-[11px] font-mono text-slate-800 select-all">
                        {currentHost}
                      </code>
                      <button
                        onClick={() => handleCopy(currentHost, 'domain')}
                        className="px-2 py-1 rounded bg-slate-200 hover:bg-slate-300 text-[11px] font-semibold text-slate-700 flex items-center gap-1 cursor-pointer"
                      >
                        {copiedField === 'domain' ? <Check className="w-3 h-3 text-emerald-600" /> : <Copy className="w-3 h-3" />}
